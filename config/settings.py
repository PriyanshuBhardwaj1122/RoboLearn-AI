...
class Settings(BaseSettings):
    ...
    # ── LLM ───────────────────────────────────────────────────────────────────
    # Providers: "ollama" | "groq" | "anthropic" | "openai"
    llm_provider: str = "ollama"
    llm_model: str = "qwen2.5:7b"          # change to qwen2.5:14b for 24GB Mac
    llm_temperature: float = 0.1            # lower = more consistent JSON output
    llm_max_tokens: int = 1024
